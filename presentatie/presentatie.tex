...
\end{frame}
    ...
    \begin{frame}{Imago en merkreputatie}
        ...
        \end{itemize}
    \end{frame}
% Wat betreft de belangen van ticketsysteembedrijven, zullen we het hebben over de marktsituatie en de concurrentie tussen 
    % deze bedrijven. De winstmaximalisatie en het imago en merkreputatie.

% De primaire ticketverkoper is voornamelijk Ticketmaster, deze behoort dus bij de primaire markt wat wilt zeggen dat zij 
    % de tickets die rechtstreeks aan ons zijn toegewezen door Evenementpartners verkopen. Terwijl in de secundaire markt,
    % de concurrerende bedrijven, zoals Eventbrite en StubHub, al verkochte primaire tickets doorverkoopt.

% Maar hoe proberen deze bedrijven hun winst te maximaliseren? Op het eerste zicht lijken de andere concurrerende sites negatief
    % voor deze bedrijven, toch is het tegendeel waar. Aangezien bv. Live Nation , het moeder bedrijf van Ticketmaster, ipv. 
    % de secundaire markt tegen te werken, heeft het een bedrijf, in dit geval TicketNow, overgenomen van de sec. markt.
    
% En als we het hebben over het Imago en merkrep, leidt zo'n soort actie wel tot een controverse. Zeker omdat Ticketmaster 
    % zelf maatregelen beweerde te nemen tegen het doorverkopen van deze tickets door de secundaire markt.
    % Natuurlijk moeten ze hun imago kunnen behouden, door bv. afspraken te volgen tussen externen zoals artiesten etc.
